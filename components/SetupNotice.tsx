  ...
  return (
    <main className="mx-auto max-w-[780px] px-4 py-14 sm:px-6">
      <div className="rounded-xl border border-border bg-surface p-5 shadow-card">
        ...
        <h1 className="mt-5 text-figure-lg font-semibold leading-[1.3] text-text-primary">Supabase setup needed</h1>
  ...
  return (
    <main className="grid min-h-viewport place-items-center px-4 py-10">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-3 text-label text-text-secondary">{message}</p>
      </div>
    </main>
  );
}
